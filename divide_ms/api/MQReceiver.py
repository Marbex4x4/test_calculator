...
class Listener():
    ...
    def __init__(self):
        ...
        channel.queue_declare(queue='queue_divide')

        channel.basic_qos(prefetch_count=1)
        channel.basic_consume(queue='queue_divide', on_message_callback=self.on_request)
...
class Operation():
    def divide(list_nums):
        ...
        logging.info("Handle response, divide result:{}".format(result) )
        return result
